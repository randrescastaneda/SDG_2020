...
.big[We have seen that, in general, the  This kind of inequality is known as relative inequality because it depends on the distribution of welfare within the context in which it is measured. That is, relative inequality does not say anything about the level of welfare between two countries. It only allows us to see if the inequality between the population of one country has increased or decreased over time, but it does not say anything about how unequal the populations of two different economies are. We need absolute measures of inequality for this endeavor. 
]
...
.big[We can't use a relative measure of inequality to compare inequality across countries]

--

.big[We need a measure that attempts to summarize a distribution in one single value. ]
