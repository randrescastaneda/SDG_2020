...
---
.left-column[
.big[Let's start with perfect equality. here we represent the population with 100 people, from the poorest to the richest. The size of the bars represents the amount of money that each person has.]
]
.right-column[
```{r pereq}
