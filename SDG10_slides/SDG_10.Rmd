...
.big[So, how can we know if a particular country is more unequal than other? By using the Gini? Not really, as it might be reflecting just the effect of the top, hidding the rest of the distribution.]
...
.left-column[
Under this perspective, where we take a measure of central tendency that is not effected by outliers (say, within-country inequality), we can see that between-country in the world has increased
]
.right-column[
```{r ginimed-u}
p_gini_med
